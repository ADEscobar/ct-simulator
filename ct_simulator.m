...
% receivers:
%
% %% BER_{BFSK} =\frac{1}{2}\exp\left(-\frac{E_{b}(t)}{2N_{0}}\right %%

% Beating parameters
A1 = 1;        % Amplitude of transmitter 1
A2 = 0;        % Amplitude of transmitter 2
...
per = ct_sim_run(M,Fs,nsamp,freqsep,A1,A2,fbeat,EbNo,N,p_length);
...
%% Simulator code
function per = ct_sim_run(M,Fs,nsamp,freqsep,A1,A2,fbeat,EbNo,N,...
    p_length)
